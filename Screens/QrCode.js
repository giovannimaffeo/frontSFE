...
export default function Screen3({navigation}) {
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <QRCodeScanner
        cameraStyle={{height: screenHeight * 1, marginTop: -screenWidth * 0.17}}
        onRead={e => confirmarPresenca(e)}
        reactivate={true}
      ...
      <View
        ...
        <LottieView
          autoPlay
          loop
          source={require('./../assets/leitorQR')}
          style={{
      ...
      <View
        style={{
          borderBottomWidth: (screenHeight - screenHeight * 0.4) / 2,
          borderTopWidth: (screenHeight - screenHeight * 0.4) / 2,
          borderLeftWidth: (screenWidth - screenHeight * 0.4) / 2,
          borderRightWidth: (screenWidth - screenHeight * 0.4) / 2,
          borderRadius: 0,
